...
const BANNERS = [
  ...
  "https://images.unsplash.com/photo-1550009158-9ebf6d4d12c8?q=80&w=1200&h=400&fit=crop",
...
export function HeroSlider() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', overflow: 'hidden', borderRadius: '8px', zIndex: 1 }} ref={emblaRef}>
      <div style={{ display: 'flex', touchAction: 'pan-y' }}>
        {BANNERS.map((src, index) => (
          <div key={index} style={{ flex: '0 0 100%', minWidth: 0, position: 'relative' }}>
            {/* Using standard img tag for simplicity and predictable sizing */}
            <img 
              src={src} 
        ...
        {BANNERS.map((_, index) => (
          <button
            ...
            style={{
              ...
              height: '8px',
              borderRadius: '4px',
              background: selectedIndex === index ? '#fff' : 'rgba(255, 255, 255, 0.5)',
              border: 'none',
              cursor: 'pointer',
