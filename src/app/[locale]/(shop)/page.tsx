  ...
  return (
    <div style={{ background: "var(--color-bg)", minHeight: "100vh", paddingBottom: "60px" }}>
      ...
      <div className="container" style={{ marginTop: "24px" }}>
        <div style={{ 
          ...
          {quickLinks.map((link, i) => (
            <div key={i} className="quick-link-item" style={{ 
              display: "flex", 
              ...
              <div className="quick-link-icon-wrapper" style={{ 
                width: "48px", 
                height: "48px", 
              ...
              <span style={{ fontSize: "12px", fontWeight: 500, lineHeight: "1.3", color: "var(--color-text-secondary)" }}>{link.label}</span>
            </div>
          ))}
        </div>
      </div>
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <Flame size={20} fill="#fff" style={{ animation: "pulse 1.5s infinite" }} />
                  <span style={{ fontSize: "18px", fontWeight: 700, letterSpacing: "1px" }}>FLASH SALE</span>
                </div>
                {/* Countdown Timer */}
                <div style={{ display: "flex", alignItems: "center", gap: "6px", marginLeft: "12px", fontSize: "14px" }}>
                  <Clock size={16} />
                  <div style={{ display: "flex", gap: "4px", fontWeight: 600 }}>
                    <span style={{ background: "#111", padding: "2px 6px", borderRadius: "4px" }}>02</span>:
                    <span style={{ background: "#111", padding: "2px 6px", borderRadius: "4px" }}>45</span>:
                    <span style={{ background: "#111", padding: "2px 6px", borderRadius: "4px" }}>12</span>
                  </div>
                </div>
              </div>
              <Link href="/products" style={{ color: "#fff", fontSize: "13px", fontWeight: 500, textDecoration: "none", display: "flex", alignItems: "center", gap: "4px" }}>
              ...
              {products.slice(0, 6).map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ position: "relative", paddingBottom: "100%", background: "var(--color-bg-secondary)" }}>
                      {product.image_url ? (
                        <img 
                        ...
                        <div style={{ position: "absolute", width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2rem", color: "#ccc" }}>☐</div>
                      )}
                    </div>
                    
                    <div style={{ padding: "10px", display: "flex", flexDirection: "column", flex: 1, gap: "6px" }}>
                      <div style={{ 
                        fontSize: "12px", 
                        color: "var(--color-text)", 
                        display: "-webkit-box", 
                      ...
                      <div style={{ marginTop: "auto" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "baseline", gap: "4px" }}>
                          <span style={{ color: "#ef4444", fontSize: "16px", fontWeight: 700 }}>
                            <span style={{ fontSize: "11px" }}>$</span>{Number(product.price).toFixed(2)}
                          </span>
                        </div>
                        <div style={{ color: "var(--color-text-tertiary)", fontSize: "11px", textDecoration: "line-through" }}>
                        ...
                        <div style={{ marginTop: "8px" }}>
                          <div style={{ 
                            ...
                            <span style={{ 
                              ...
                              fontSize: "8px", 
                              fontWeight: 700, 
                              color: mockSoldPercentage > 50 ? "#fff" : "#ef4444", 
                              zIndex: 1 
                            }}>
      ...
      {["computer", "mobile"].map((category) => {
        ...
        return (
          <div key={`section-${category}`} className="container" style={{ marginTop: "24px" }}>
            <div style={{ 
              background: "var(--color-surface)", 
              ...
              <h2 style={{ 
                ...
                <Sparkles size={16} />
                {category === "computer" ? "Computers (ကွန်ပျူတာများ)" : "Mobiles (ဖုန်းများ)"}
              </h2>
              <Link 
                href={`/products?category=${category}`} 
                style={{ 
                ...
                >
                  ...
                  <div style={{ padding: "10px", display: "flex", flexDirection: "column", flex: 1, gap: "6px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto", paddingTop: "4px" }}>
                      <div style={{ color: "var(--color-primary)", fontSize: "15px", fontWeight: 700 }}>
                        <span style={{ fontSize: "11px" }}>$</span>{Number(product.price).toFixed(2)}
                      </div>
                    </div>
                  </div>
