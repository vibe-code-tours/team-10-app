...
*(Chat အသစ်တိုင်း ကုဒ်မရေးခင် အထက်ပါအတိုင်း context ပြန်ဆွဲ၊ bilingual summary ပြ၊ .agents/ ထဲရှိ `.md` content အသစ်များအတွက် Bilingual rule (အင်္ဂလိပ် + မြန်မာ) လိုက်နာရန် သတိပြုပြီးမှ user ရဲ့ task ကို စောင့်ပါ။)*
